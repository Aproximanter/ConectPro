...
<div class="container">
    ...
    <form method="post" action="insert_profesionista.php">
        <div class="mb-3">
    ...
    <form method="post" action="update_profesionista.php" class="edit-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="edit-foto_perfil" name="foto_perfil">
        </div>
...
$(".eliminar-profesionista").click(function() {
    ...
    $(".editar-profesionista").click(function() {
        ...
        $("#edit-foto_perfil").val(foto_perfil);
